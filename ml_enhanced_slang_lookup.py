...
try:
    ...
    print("⚠️ Transformers not available. BERT features will be disabled.")
...
class MLEnhancedSlangDictionary:
    def __init__(self, data_dir='urbandict'):
        ...
        try:
            ...
            print("⚠️ Main dataset not found, continuing with translation files only")
        ...
        try:
            ...
            print("⚠️ slang_translation2.csv not found")
        ...
        try:
            ...
            print("⚠️ slang_corpus_chunk_1_to_4.csv not found")
    ...
    def _initialize_ml_models(self):
        """Initialize text classification models (Naive Bayes and Logistic Regression)"""
        try:
        ...
        try:
            ...
            if all_terms and all_definitions:
                ...
                if len(self.corpus) > 0:
                    ...
                    print("⚠️ No valid data for similarity index")
            else:
                self.tfidf_matrix = None
                self.corpus = []
                self.term_list = []
                print("⚠️ No data available for similarity index")
                
        except Exception as e:
            print(f"⚠️ Error building TF-IDF index: {e}")
            self.tfidf_matrix = None
            self.corpus = []
            self.term_list = []
    ...
    def _find_similar_terms_tfidf(self, query, max_results=3, threshold=0.1):
        ...
        try:
            ...
            print(f"⚠️ Error in TF-IDF similarity search: {e}")
            return []
    ...
    def _classify_text_type(self, text):
        ...
        try:
            ...
            print(f"⚠️ Error in ML classification: {e}")
            return self._detect_input_type_heuristic(text)
    ...
    def _detect_context_bert(self, text):
        ...
        try:
            ...
            print(f"⚠️ Error in BERT context detection: {e}")
            return self._detect_context_heuristic(text)
